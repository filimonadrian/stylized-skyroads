...
// Am facut si primul bonus, in care se modifica unghiul pentru spot
// se folosesc tastele T si R pentru a modifica unghiul
...
void Laborator8::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
	...
	int type = glGetUniformLocation(shader->program, "is_spot");
	glUniform1i(type, is_spot);

	int cut_angle = glGetUniformLocation(shader->program, "cut_off_angle");
